...
Use a user-authorized logged-in Chrome session, DokoBot, an in-app browser, or any equivalent dynamic browser capability. Treat tool names as examples, not required dependencies. Follow [browser-collection.md](browser-collection.md).
